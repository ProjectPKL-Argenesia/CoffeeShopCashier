...
@section('content')
    ...
    <section class="h-screen p-10 bg-gray-300">
        ...
        <div
            ...
            <form action="{{ route('menuList.index') }}" method="GET" id="searchForm">
                <div
            ...
            @foreach ($dataMenu as $item)
                <div data-category-id="{{ $item->menu_category->id }}"
                    ...
                    <div
                        ...
                        <img src="{{ asset('storage/' . $item->image) }}" class="object-contain w-full h-full"
                            alt="gambar">
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            clearSearch.click(function() {
                ...
                clearSearch.hide();
                if (formSubmitted) {
                    window.location.href = "{{ route('menuList.index') }}";
                }
            });
        });
    </script>
