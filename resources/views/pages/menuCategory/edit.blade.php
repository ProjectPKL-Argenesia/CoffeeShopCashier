                    ...
                    <div class="grid grid-cols-12 col-span-12">
                        ...
                        <div class="flex col-span-9 py-2 gap-x-2">
                            <div id="foodType-Edit-{{ $item->id }}"
                                ...
                                <input type="radio" name="type" id="food-edit-{{ $item->id }}" value="Food"
                                    class="text-gray-500 focus:ring-0" {{ $item->type == 'Food' ? 'checked' : '' }}>
                            </div>
                            <div id="drinkType-Edit-{{ $item->id }}"
                                ...
                                <input type="radio" name="type" id="drink-edit-{{ $item->id }}" value="Drink"
                                    class="text-gray-500 focus:ring-0" {{ $item->type == 'Drink' ? 'checked' : '' }}>
                            </div>
                        </div>
                    </div>
