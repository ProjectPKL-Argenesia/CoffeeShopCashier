        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 text-center md:p-5">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500">Are
                    you sure you want to delete <span class="font-bold">{{ $item->category_name }}</span>?</h3>
                <form action="{{ route('menuCategory.destroy', $item->id) }}" method="POST" class="inline-flex">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
