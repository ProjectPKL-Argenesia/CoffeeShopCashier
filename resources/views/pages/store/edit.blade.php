    ...
    <div class="relative p-4 w-full max-w-[40%] min-w-[35%] max-h-full">
        <div class="relative bg-white rounded-lg shadow">
            ...
            @foreach ($dataStore as $itemStore)
                <form action="{{ route('store.update', $itemStore->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="grid grid-cols-12 px-8 pt-16 pb-10 gap-y-4">
                        <div class="grid grid-cols-12 col-span-12">
                            ...
                            <div class="col-span-9">
                                <input type="text" name="name" id="name" value="{{ $itemStore->name }}"
                        ...
                        <div class="grid grid-cols-12 col-span-12">
                            ...
                            <div class="col-span-9">
                                <input type="text" name="address" id="address" value="{{ $itemStore->address }}"
                                    class="w-full px-2 py-1 bg-gray-200 rounded-lg focus:ring-0"
                        ...
                        <button type="submit"
                            class="col-span-12 mt-5 py-2 text-sm text-gray-100 bg-gray-800 rounded-lg">Done</button>
                    </div>
                </form>
            @endforeach
        </div>
